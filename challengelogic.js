...
THIS IS SOME LEGACY CODE WHICH WAS PORTED FROM THE ORIGINAL JAVA SWING APPLICATION.

THROUGH SOME HACKING AND REPLACING AND STUFF I WILL BE ABLE TO PORT IT TO JAVASCRIPT TO WORK WITH THE APP

FOR NOW JUST DONT TOUCH IT
...
$("#s").attr("title","named after the city of Darmstadt, where it was discovered");
$("#Rg").attr("title"," is calculated to have similar properties to copper, silver, and gold");
$("#ub").attr("title","unknown b");
